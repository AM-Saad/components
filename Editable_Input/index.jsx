...
const EditableInput: React.FC<Props> = ((props, ref) => {
  ...
  const { loading, inputType, label, required, validationMessage, onSave, defaultVal, updateBtnText, cancelBtnText, id } = props
  ...
  useEffect(() => setNewVal(defaultVal), [defaultVal])
      ...
      <div className="editable-input text-left border-b-1-g mb-6 pb-2 border-b" key={id} id={id}>
        ...
        {isEditing && <div >
          <input
            ...
            defaultValue={newVal} />
          <p className='text-red-400 mt-2 editable-input_error'>{error}</p>
